...
![Power curves from wind tunnel testing]({{ "/assets/images/blade-powercurves.jpg" | relative_url }}){: .inline-image-l style="width: 420px; border: 3px solid #000; border-radius: 5px;"}
